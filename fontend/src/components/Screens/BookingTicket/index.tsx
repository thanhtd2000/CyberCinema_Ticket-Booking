...
function BookingTicketScreen() {
  ...
  const {
    ...
    { id: valueRoom?.id, schedule_id: valueRoom?.schedule_id, randomNumber: Math.random() as number },
    token,
  );
  useEffect(() => {
    refetch();
          ...
          {component && component === 1 ? (
            <Col xs={24} sm={24} md={24} lg={18} className={style.bookChair}>
              ...
              <div className={style.time}>
                ...
                {(dataChair?.time && !isLoading) || !isFetching ? (
                  <CountTime expiresAt={dataChair?.time} />
                ) : (
                  <Spin></Spin>
                )}
              </div>
            ...
            <OrderTicket
              selectedBoxes={selectedBoxes}
              totalPrice={totalPrice + movieDetail?.price}
              expiresAt={dataChair?.time}
            ></OrderTicket>
          )}
            ...
            <Row gutter={[{ sm: 24, md: 24, lg: 0 }, 0]}>
              ...
              <Col xs={24} sm={14} md={16} lg={24}>
                ...
                {component === 1 ? (
                  ...
                  <Row className={style.submitTicket} gutter={[10, 10]}>
                    <Col span={12}>
